...
titleTh: "Terminal & AI CLI: คู่มือลัดที่ผมเปิดดูซ้ำตลอด"
date: "2026-05-02"
excerpt: "The keys, plugins, and AI CLIs I forget every two weeks — written down so I (and you) can Ctrl+F next time."
excerptTh: "ปุ่มลัด ปลั๊กอิน และ AI CLI ที่ผมลืมทุก ๆ สองสัปดาห์ — จดไว้ที่นี่ให้กด Ctrl+F หาได้ครั้งหน้า"
